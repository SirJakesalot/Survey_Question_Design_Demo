...
class QuestionsTableViewController: UIViewController, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell{
        let cell = self.TableQuestions.dequeueReusableCellWithIdentifier("questionCell") as UITableViewCell!
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject!) {
        let selectedRowIndex = self.TableQuestions.indexPathForSelectedRow
